...
A basic local setup includes usage of [Twilio](local_setup/telephony_server/twilio_api_server.py) for telephony. We have dockerized the setup in `local_setup/`. One will need to populate an environment `.env` file from `.env.sample`.
...
1. `docker-compose build --no-cache voiceaiagent-app <twilio-app>`: rebuild images
2. `docker-compose up voiceaiagent-app <twilio-app>`: run the build images
...
https://github.com/bolna-ai/bolna/blob/10fa26e5985d342eedb5a8985642f12f1cf92a4b/voiceaiagent/providers.py#L30-L47
...
https://github.com/bolna-ai/bolna/blob/c8a0d1428793d4df29133119e354bc2f85a7ca76/voiceaiagent/providers.py#L7-L14
